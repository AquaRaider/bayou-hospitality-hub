  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        /* Bayou Hospitality Brand Colors */
        "bayou-deep-blue": "hsl(var(--bayou-deep-blue))",
        "bayou-gold": "hsl(var(--bayou-gold))",
        "bayou-red": "hsl(var(--bayou-red))",
      ...
      fontFamily: {
        sans: ["Questrial", "sans-serif"],   // body text
        serif: ["BodoniXT", "serif"],        // headings
      },
